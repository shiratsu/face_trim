...
(X_train, y_train)= face_input.read_data('train.csv')
(X_test, y_test)= face_input.read_data('test.csv')
...
#model.add(Conv2D(32, (3, 3), padding='same', input_shape=X_train.shape[0:]))
